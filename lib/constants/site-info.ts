...
export const SITE_INFO = {
  ...
  warranty: {
    period: '1 ANO',
    disclaimer:
      '*Consulte os termos vigentes e aplicabilidade no ato da compra.',
  },
  ...
  experience: {
    ...
    disclaimer:
      '*Experiência acumulada no segmento de smartphones e tecnologia móvel.',
  },

  routes: {
    home: '/',
    catalog: '/catalogo',
    catalogUnderConstruction: '/catalogo',
    admin: {
      login: '/admin/login',
